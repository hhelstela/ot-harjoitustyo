...
class Login:
    def __init__(self):
        ...
        self.login_label = tk.Label(self.root, text="TaskApp Login", font=('Arial', 20))
        ...
        self.password_label = tk.Label(self.login_frame, text='Username', font=('Arial', 12))
        ...
        self.login_button = tk.Button(self.login_frame, text='Login', command=lambda : self.login())
        self.login_button.grid(row=4)
        self.create_button = tk.Button(self.login_frame, text='Create Account', command=lambda : self.create_account())
