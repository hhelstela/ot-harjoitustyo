...
class GUI:
    def __init__(self, user, password):
        ...
        self.usermenu.add_command(
            label='Change User', command=lambda: self.change_user())
        ...
        self.tasklabel = tk.Label(
            self.root, text="Task Title", font=('Arial', 16))
        self.tasklabel.pack()
        ...
        self.detaillabel = tk.Label(
            self.root, text='Details', font=('Arial', 16))
        ...
        self.addbutton = tk.Button(
            self.root, text='Add Task', command=lambda: self.add_task())
        self.addbutton.pack()
        ...
        self.deletebutton0 = tk.Button(
            self.calendarframe, text='Done', command=lambda: self.delete(self.tasklist0))
        ...
        self.deletebutton1 = tk.Button(
            self.calendarframe, text='Done', command=lambda: self.delete(self.tasklist1))
        ...
        self.deletebutton2 = tk.Button(
            self.calendarframe, text='Done', command=lambda: self.delete(self.tasklist2))
        ...
        self.deletebutton3 = tk.Button(
            self.calendarframe, text='Done', command=lambda: self.delete(self.tasklist3))
        ...
        self.deletebutton4 = tk.Button(
            self.calendarframe, text='Done', command=lambda: self.delete(self.tasklist4))
        ...
        self.deletebutton5 = tk.Button(
            self.calendarframe, text='Done', command=lambda: self.delete(self.tasklist5))
        ...
        self.deletebutton6 = tk.Button(
            self.calendarframe, text='Done', command=lambda: self.delete(self.tasklist6))
    ...
    def add_task(self):
        tasklists = [self.tasklist0, self.tasklist1, self.tasklist2,
                     self.tasklist3, self.tasklist4, self.tasklist5, self.tasklist6]
